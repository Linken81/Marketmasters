...
function unlockAchievement(id) {
  ...
  state.achievements[id] = true; // boolean flag only, no dates
  if (spec) {
...
const MISSION_CANDIDATES = [
  ...
  { id: 'hold_10', text: 'Hold a stock for 10 ticks', check: (p) => false, reward: { coins: 80, xp: 30 } }, // hold handled specially
